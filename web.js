...
;
	($.$mol_icon_reload) = class $mol_icon_reload extends ($.$mol_icon) {
		path(){
...
;
	($.$hyoo_github_compare) = class $hyoo_github_compare extends ($.$mol_page) {
		Theme(){
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/hyoo-ru/github.hyoo.ru/tree/master/compare");
			return obj;
		}
		add_query(next){
			if(next !== undefined) return next;
		...
		issues_label(){
			return (this.$.$mol_locale.text("$hyoo_github_compare_issues_label"));
		}
		Issues_label(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.issues_label())]);
			return obj;
		}
		capacity_label(){
			return (this.$.$mol_locale.text("$hyoo_github_compare_capacity_label"));
		}
		Capacity_label(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.capacity_label())]);
			return obj;
		}
		columns(){
			return [
		...
		Content(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Columns()), (this.Projects())]);
			return obj;
		}
		homepage(id){
			return "";
		...
		Issues_portion(id){
			...
			(obj.portion) = () => ((this.issues_portion(id)));
			return obj;
		}
		Issues(id){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ((this.issues_link(id)));
			(obj.sub) = () => ([(this.Issues_count(id)), (this.Issues_portion(id))]);
			return obj;
		}
		capacity_text(id){
			return "";
		...
		Capacity_info(id){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Capacity_text(id)), (this.Capacity_portion(id))]);
			return obj;
		}
		...
		Capacity(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Capacity_info(id)), (this.Capacity_refresh(id))]);
			return obj;
		}
		title(){
		...
		tools(){
			return [(this.Light()), (this.Sources())];
		}
		body(){
			return [(this.Content())];
		}
	...
	($mol_mem(($.$hyoo_github_compare.prototype), "Theme"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Light"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Sources"));
	($mol_mem(($.$hyoo_github_compare.prototype), "add_query"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "add"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Add"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Issues_label"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Capacity_label"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Columns"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Projects"));
	($mol_mem(($.$hyoo_github_compare.prototype), "Content"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Homepage"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Repo"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Remove_icon"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "remove"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Remove"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Issues_count"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Issues_portion"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Issues"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Capacity_text"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Capacity_portion"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Capacity_info"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Capacity_refresh_icon"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "refresh"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Capacity_refresh"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Capacity"));
	($mol_mem_key(($.$hyoo_github_compare.prototype), "Project"));
...
(function ($) {
    ...
    __decorate([
        $mol_action
    ], $mol_shared, "value", null);
    __decorate([
        $mol_action
    ], $mol_shared, "daily", null);
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_github_compare extends $.$hyoo_github_compare {
            ...
            project(id) {
                return this.$.$mol_shared.daily(id, () => {
                    const res = this.$.$mol_fetch.json(this.uri_project(id));
                    return {
            ...
            issues_page({ id, page }) {
                return this.$.$mol_fetch.json(this.uri_issues(id) + '&page=' + page);
            }
            issues(id) {
                return this.$.$mol_range2(index => this.issues_page({ id, page: Math.floor(index / 100) })[index % 100], () => this.project(id).open_issues_count);
            }
            capacity(id) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_github_compare.prototype, "project_ids", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_github_compare.prototype, "project", null);
        __decorate([
            $mol_mem
        ], $hyoo_github_compare.prototype, "issues_max", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_github_compare.prototype, "issues_page", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_github_compare.prototype, "issues", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_github_compare.prototype, "capacity", null);
        __decorate([
            $mol_mem
        ], $hyoo_github_compare.prototype, "capacity_max", null);
        __decorate([
            $mol_mem
        ], $hyoo_github_compare.prototype, "add_suggests", null);
        $$.$hyoo_github_compare = $hyoo_github_compare;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
